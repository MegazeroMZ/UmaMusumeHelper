eventData = [
    ...
    ################# URA FINALS ####################
    {"name": "Exhilarating! What a Scoop!", "options": {"opt1": "Stamina +10", "opt2": "Guts +10"}},
    {"name": "A Trainer's Knowledge", "options": {"opt1": "Power +10", "opt2": "Speed +10"}},
    {"name": "Best Foot Forward!", "options": {"opt1": "Energy -10, Power +20, Guts +20, Beeline Burst hint +1", "opt2": "Energy +30, Stamina +20, Breath of Fresh Air hint +1"}},
    # Placeholders
